...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_Left.setText(_translate("MainWindow", "Pan Left", None))
        self.btn_Right.setText(_translate("MainWindow", "Pan Right", None))
        self.btn_Down.setText(_translate("MainWindow", "Tilt Down", None))
        self.btn_Up.setText(_translate("MainWindow", "Tilt Up", None))
